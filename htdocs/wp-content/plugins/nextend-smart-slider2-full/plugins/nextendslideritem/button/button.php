...
class plgNextendSliderItemButton extends plgNextendSliderItemAbstract {
    ...
    function getTemplate(){
        return "
<div class='nextend-smartslider-button-{buttonclass}-container {fontclass}' style='cursor:pointer; width: 100%;' data-click='{onmouseclick}' data-enter='{onmouseenter}' data-leave='{onmouseleave}'>
